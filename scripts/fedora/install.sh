...
PKG_RPM_URIS="
    https://github.com/wez/wezterm/releases/download/20240203-110809-5046fc22/wezterm-20240203_110809_5046fc22-1.fedora38.x86_64.rpm
    https://github.com/duplicati/duplicati/releases/download/v2.1.0.3_beta_2025-01-22/duplicati-2.1.0.3_beta_2025-01-22-linux-x64-gui.rpm
...
PACKAGES_TO_INSTALL="$PKG_RPM_URIS $PKGS_APPS $PKGS_LIBS $PKGS_MEDIA $PKGS_IMG"
