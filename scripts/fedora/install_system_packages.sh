...
# Package categories
PKGS_APPS='chromium duplicity duply figlet gedit gimp git htop inkscape keepassx nmap ntp p7zip pv telnet terminator tig tree tmux wget'
PKGS_DEV='lua-devel npm php-devel ruby-devel rubygems java-1.8.0-openjdk'
PKGS_LIBS='ctags gcc gcc-c++ kernel-devel libffi-devel libxml2-devel libxslt-devel libX11-devel ncurses-devel ntfsprogs openssl-devel rpm-build redhat-rpm-config tcl-devel xdg-utils xz-libs zlib-devel bzip2-devel yum-utils'
