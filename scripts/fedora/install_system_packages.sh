...
PKGS_GNOME='f21-backgrounds-extras-gnome f22-backgrounds-extras-gnome f23-backgrounds-extras-gnome f24-backgrounds-extras-gnome f25-backgrounds-extras-gnome alacarte shutter dconf-editor gnome-tweak-tool gnome-shell-browser-plugin gnome-shell-extension-user-theme gnome-shell-extension-workspace-indicator gnome-shell-extension-screenshot-window-sizer gnome-shell-extension-auto-move-windows gnome-shell-extension-drive-menu'
