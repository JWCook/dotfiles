...
set VF_SITE_PACKAGES ~/.local/lib/python3.10/site-packages/virtualfish
# set VF_SITE_PACKAGES ~/.pyenv/versions/3.10.4/lib/python3.10/site-packages/virtualfish
